...
# Vernacular High-Volatility Keywords for Breaking Alert Classification
CRITICAL_KEYWORDS = [
    "breaking", "crash", "alert", "deadly", "collapse", "attack", "scam", "arrested", "cabinet", "election",
    "ब्रेकिंग", "धमाका", "घोटाला", "गिरफ्तार", "हादसा", "मौत", "क्रैश", "इस्तीफा", "विस्फोट", "बजट", "चुनाव", "अभीतक"
]
...
def main():
    ...
    print(f"🚀 Master Ledger Compilation successful. Ingested {total_new_ingested} updates.")
